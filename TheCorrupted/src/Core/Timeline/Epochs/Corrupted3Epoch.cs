...
{
    public class Corrupted3Epoch : EpochModel
    {
        public override string Id => "THECORRUPTED-CORRUPTED3_EPOCH";
        ...
        public static List<RelicModel> Relics
        {
            get
            {
                ...
                int num2 = 0;
                span[num2] = ModelDb.Relic<Armynomicon>();
                num2++;
                span[num2] = ModelDb.Relic<BlueCandle>();
                num2++;
                span[num2] = ModelDb.Relic<DuVuDoll>();
                return list;
            }
        }
