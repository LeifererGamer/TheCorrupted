...
namespace TheCorrupted.src.Core.Models.Cards.Uncommon
{
    internal class CorruptedSpellbook() : CardModel(0, CardType.Skill, CardRarity.Uncommon, TargetType.Self)
    {
        ...
        protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
        {
            ...
            IEnumerable<CardModel> curses = CardFactory.GetDistinctForCombat(base.Owner, ModelDb.CardPool<CurseCardPool>().GetUnlockedCards(base.Owner.UnlockState, base.CombatState.RunState.CardMultiplayerConstraint), 1, base.CombatState.RunState.Rng.CombatCardGeneration);
