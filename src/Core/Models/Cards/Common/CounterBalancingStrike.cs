...
internal class CounterBalancingStrike() : CardModel(1, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
    {
        ...
        protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
        {
            ...
            await CardPileCmd.Draw(choiceContext, PileType.Hand.GetPile(cardPlay.Card.Owner).Cards.Count((CardModel c) => c.Type.Equals(CardType.Curse) || c.Type.Equals(CardType.Status)), base.Owner);
        }
